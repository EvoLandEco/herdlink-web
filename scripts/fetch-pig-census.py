...
def build():
    ...
    return {
        "metadata": {
            ...
            "method": "Published COROP pig and pig-holding totals divided by the same year's published COROP land area in square kilometres. Water is excluded. Densities are rounded to six decimal places.",
            "missingValues": "Null means CBS has no published numeric value. A density is null when its count or land area is null. Published zero is retained as zero; no values are estimated.",
            "geography": "Census records use the COROP classification of their reference year. The map displays 2024 COROP boundaries; these values are not recalculated to 2024 geography.",
            "landAreaSurveyYears": {"2018": 2015, "2019": 2015, "2020": 2015, "2021": 2015, "2022": 2017},
            "caveats": [
                "Agricultural activities are assigned to the business's main establishment address, which can differ from where animals are kept. Holdings are businesses with pigs, not a count of separate farm sites.",
                ...
                "These are annual census observations, not the number of animals or holdings involved in the displayed trade network, and they do not alter the disease model.",
            ],
            "sources": [
                {
                    "table": "80781ned",
