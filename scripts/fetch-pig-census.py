...
def build():
    ...
    return {
        "metadata": {
            ...
            "geography": "CBS assigns pig totals and business totals to the business's main establishment address, using the COROP classification of the reference year. The map displays 2024 COROP boundaries.",
            "publicationSchedule": "The municipal table normally publishes provisional census figures in November and definitive figures in March of the following year. This extract contains published definitive values; historical release vintages require separate source records.",
            "landAreaSurveyYears": {"2018": 2015, "2019": 2015, "2020": 2015, "2021": 2015, "2022": 2017},
            "caveats": [
                "Pig and holding totals follow the business's main establishment address. Animals can be kept at sites in other regions. Holdings count businesses with pigs.",
                ...
                "The animal reference date is 1 April. A published zero describes that census observation; recorded movements can occur at other dates. Null denotes an unavailable value.",
                ...
                "Annual census observations provide map context alongside trade records. The simulation uses declared synthetic population units; geographic alignment with animal sites is a separate validation step.",
            ],
            "sources": [
                {
                    "table": "80781ned",
